...
Los cuerpos de respuesta siguen `CategoriaMuebleDto` (`id`, `nombre`, `created_at`, `updated_at`). Ver casos de uso y esquemas Zod en `src/presentation/schemas/categoria-mueble.schema.ts` para cuerpos de petición.
