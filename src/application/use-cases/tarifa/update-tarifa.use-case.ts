...
import { UpdateTarifaDto, TarifaDto, toTarifaDto } from "../../dtos/tarifa.dto";
...
export class UpdateTarifaUseCase {
  ...
  async execute(id: string, input: UpdateTarifaDto): Promise<TarifaDto> {
